    ...
    <>
      <div className="">
        <div className="flex gap-1 m-2">
          <button
            className="flex items-center justify-center p-2 w-8 h-8 rounded-full shadow-md  border bg-blue-400 hover:bg-blue-500 text-white"
        ...
        <div>
          <button
            ...
            className="p-4 border w-full font-bold shadow-md bg-blue-400 hover:bg-blue-500 text-white rounded-md"
          >
            Agregar al carrito
          </button>
        </div>
